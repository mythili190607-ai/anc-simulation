...
Laptop/Desktop version - No GPIO required
"""
...
def build_arg_parser():
    p = argparse.ArgumentParser(description="Real-time multi-algorithm ANC Simulator")
...
def main():
    ...
    # Process audio
    print(f"[Simulator] Processing {args.duration}s of audio at {args.samplerate}Hz...")
    ...
    print(f"\n[Simulator] Processing complete in {elapsed:.2f}s")
